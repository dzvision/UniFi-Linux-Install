...
release_wanted () {
  if [[ "${is_there_a_release_candidate}" == 'no' ]]; then
    ...
    case "$release_stage" in
        1*|"")
          ...
          if [[ "${unifi}" =~ (6.0.29|6.0.42|6.1.61|6.1.65|6.1.67|6.1.70|6.2.17|6.5.51|6.5.52) ]]; then
            header_red
  ...
  if [[ "${release_stage}" == 'RC' ]]; then rc_version_available="6.5.55"; rc_version_available_secret="6.5.55-1d0581c00d"; fi
}
...
unifi_cache_download() {
  ...
  while read -r device_model; do
    ...
    if ! grep -iq "${device_model}" /tmp/EUS/firmware/available; then
      if grep -iq "${device_model}" /tmp/EUS/firmware/currently_cached; then
    ...
    if [[ "${removed_cached_fw}" == 'true' ]] || grep -iq "${device_model}" /tmp/EUS/firmware/available &> /dev/null; then
...
os_upgrade () {
  ...
  if dpkg -l mongodb-org 2> /dev/null | awk '{print $1}' | grep -iq "^ii\\|^hi"; then
    ...
    elif [[ "${os_codename}" =~ (xenial|sarah|serena|sonya|sylvia|bionic|tara|tessa|tina|tricia|cosmic|disco|eoan|focal|groovy|hirsute|impish) ]]; then
...
mongodb_upgrade_34_36() {
  ...
  if [[ "${mongodb_org_v::2}" == '36' ]]; then
    echo -e "${WHITE_R}#${RESET} Updating featureCompatibilityVersion!"
    if mongo --quiet --port 27117 --eval 'db.adminCommand( { setFeatureCompatibilityVersion: "3.6" } )' | sed -e 's/ //g' -e 's/"//g' | grep -iq "ok:1"; then
...
application_upgrade_releases() {
  ...
  if wget "${wget_progress[@]}" -qO "$unifi_temp" "https://dl.ui.com/unifi/${application_version}/unifi_sysvinit_all.deb"; then echo -e "${GREEN}#${RESET} Successfully downloaded UniFi Network version ${application_version_release}! \\n"; elif wget "${wget_progress[@]}" -qO "$unifi_temp" "https://dl.ui.com/unifi/${application_version_release}/unifi_sysvinit_all.deb"; then echo -e "${GREEN}#${RESET} Successfully downloaded UniFi Network version ${application_version_release}! \\n"; else echo -e "${RED}#${RESET} Failed to download UniFi Network version ${application_version_release}...\\n"; abort; fi
...
if [[ "${first_digit_unifi}" == '5' && "${second_digit_unifi}" =~ ^(0|1|2|3|4|5)$ ]]; then
  ...
  echo -e " [   ${WHITE_R}4${RESET}   ]  |  5.11.50"
  echo -e " [   ${WHITE_R}5${RESET}   ]  |  5.12.72"
  echo -e " [   ${WHITE_R}6${RESET}   ]  |  5.13.32"
  echo -e " [   ${WHITE_R}7${RESET}   ]  |  5.14.23"
  echo -e " [   ${WHITE_R}8${RESET}   ]  |  6.0.45"
  echo -e " [   ${WHITE_R}9${RESET}   ]  |  6.1.71"
  echo -e " [   ${WHITE_R}10${RESET}  ]  |  6.2.26"
  echo -e " [   ${WHITE_R}11${RESET}  ]  |  6.4.54"
  echo -e " [   ${WHITE_R}12${RESET}  ]  |  6.5.55"
  if [[ "${release_stage}" == 'RC' ]]; then
  ...
  case "$UPGRADE_VERSION" in
      ...
      3)
        unifi_update_start
        unifi_firmware_requirement
        application_version="5.10.27"
        application_upgrade_releases
        unifi_update_finish;;
      4)
        unifi_update_start
        unifi_firmware_requirement
        application_version="5.11.50"
        application_upgrade_releases
        unifi_update_finish;;
      5)
        unifi_update_start
        unifi_firmware_requirement
        application_version="5.12.72"
        application_upgrade_releases
        unifi_update_finish;;
      6)
        unifi_update_start
        unifi_firmware_requirement
        application_version="5.13.32"
        application_upgrade_releases
        unifi_update_finish;;
      7)
        unifi_update_start
        unifi_firmware_requirement
        application_version="5.14.23"
        application_upgrade_releases
        unifi_update_finish;;
      8)
        unifi_update_start
        unifi_firmware_requirement
        application_version="6.0.45"
        application_upgrade_releases
        unifi_update_finish;;
      9)
        unifi_update_start
        unifi_firmware_requirement
        application_version="6.1.71"
        application_upgrade_releases
        unifi_update_finish;;
      10)
        unifi_update_start
        unifi_firmware_requirement
        application_version="6.2.26"
        application_upgrade_releases
        unifi_update_finish;;
      11)
        unifi_update_start
        unifi_firmware_requirement
        application_version="6.4.54"
        application_upgrade_releases
        unifi_update_finish;;
      12)
        unifi_update_start
...
##########################################################################################################################################################################
  ...
  if [[ "${unifi}" == "5.6.40" || "${unifi}" == "5.6.41" ]]; then
    ...
    echo -e " [   ${WHITE_R}3${RESET}   ]  |  5.11.50"
    echo -e " [   ${WHITE_R}4${RESET}   ]  |  5.12.72"
    echo -e " [   ${WHITE_R}5${RESET}   ]  |  5.13.32"
    echo -e " [   ${WHITE_R}6${RESET}   ]  |  5.14.23"
    echo -e " [   ${WHITE_R}7${RESET}   ]  |  6.0.45"
    echo -e " [   ${WHITE_R}8${RESET}   ]  |  6.1.71"
    echo -e " [   ${WHITE_R}9${RESET}   ]  |  6.2.26"
    echo -e " [   ${WHITE_R}10${RESET}  ]  |  6.4.54"
    echo -e " [   ${WHITE_R}11${RESET}  ]  |  6.5.55"
    if [[ "${release_stage}" == 'RC' ]]; then
    ...
    echo -e " [   ${WHITE_R}2${RESET}   ]  |  5.11.50"
    echo -e " [   ${WHITE_R}3${RESET}   ]  |  5.12.72"
    echo -e " [   ${WHITE_R}4${RESET}   ]  |  5.13.32"
    echo -e " [   ${WHITE_R}5${RESET}   ]  |  5.14.23"
    echo -e " [   ${WHITE_R}6${RESET}   ]  |  6.0.45"
    echo -e " [   ${WHITE_R}7${RESET}   ]  |  6.1.71"
    echo -e " [   ${WHITE_R}8${RESET}   ]  |  6.2.26"
    echo -e " [   ${WHITE_R}9${RESET}   ]  |  6.4.54"
    echo -e " [   ${WHITE_R}10${RESET}  ]  |  6.5.55"
    if [[ "${release_stage}" == 'RC' ]]; then
...
elif [[ "${first_digit_unifi}" == '5' && "${second_digit_unifi}" =~ ^(7|8|9)$ ]]; then
  release_wanted
  header
  echo "  To what UniFi Network Application version would you like to update?"
  echo -e "  Currently your UniFi Network Application is on version ${WHITE_R}$unifi${RESET}"
...
##########################################################################################################################################################################
...
elif [[ "${first_digit_unifi}" == '5' && "${second_digit_unifi}" == '10' ]]; then
  release_wanted
  header
  echo "  To what UniFi Network Application version would you like to update?"
  echo -e "  Currently your UniFi Network Application is on version ${WHITE_R}$unifi${RESET}"
  ...
  if [[ "${unifi}" == "5.10.27" ]]; then
    ...
    echo -e " [   ${WHITE_R}1${RESET}   ]  |  5.11.50"
    echo -e " [   ${WHITE_R}2${RESET}   ]  |  5.12.72"
    echo -e " [   ${WHITE_R}3${RESET}   ]  |  5.13.32"
    echo -e " [   ${WHITE_R}4${RESET}   ]  |  5.14.23"
    echo -e " [   ${WHITE_R}5${RESET}   ]  |  6.0.45"
    echo -e " [   ${WHITE_R}6${RESET}   ]  |  6.1.71"
    echo -e " [   ${WHITE_R}7${RESET}   ]  |  6.2.26"
    echo -e " [   ${WHITE_R}8${RESET}   ]  |  6.4.54"
    echo -e " [   ${WHITE_R}9${RESET}   ]  |  6.5.55"
    if [[ "${release_stage}" == 'RC' ]]; then
...
elif [[ "${first_digit_unifi}" == '5' && "${second_digit_unifi}" == '11' ]]; then
  release_wanted
  header
  echo "  To what UniFi Network Application version would you like to update?"
  echo -e "  Currently your UniFi Network Application is on version ${WHITE_R}$unifi${RESET}"
  echo -e "\\n  Release stage is set to | ${WHITE_R}${release_stage_friendly}${RESET}\\n\\n"
  if [[ "${unifi}" == "5.11.50" ]]; then
    unifi_version='5.11.50'
    echo -e " [   ${WHITE_R}1${RESET}   ]  |  5.12.72"
    echo -e " [   ${WHITE_R}2${RESET}   ]  |  5.13.32"
    echo -e " [   ${WHITE_R}3${RESET}   ]  |  5.14.23"
    echo -e " [   ${WHITE_R}4${RESET}   ]  |  6.0.45"
    echo -e " [   ${WHITE_R}5${RESET}   ]  |  6.1.71"
    echo -e " [   ${WHITE_R}6${RESET}   ]  |  6.2.26"
    echo -e " [   ${WHITE_R}7${RESET}   ]  |  6.4.54"
    echo -e " [   ${WHITE_R}8${RESET}   ]  |  6.5.55"
    if [[ "${release_stage}" == 'RC' ]]; then
...
elif [[ "${first_digit_unifi}" == '5' && "${second_digit_unifi}" == '12' ]]; then
  release_wanted
  header
  echo "  To what UniFi Network Application version would you like to update?"
  echo -e "  Currently your UniFi Network Application is on version ${WHITE_R}$unifi${RESET}"
  echo -e "\\n  Release stage is set to | ${WHITE_R}${release_stage_friendly}${RESET}\\n\\n"
  if [[ "${unifi}" == "5.12.72" ]]; then
    unifi_version='5.12.72'
    echo -e " [   ${WHITE_R}1${RESET}   ]  |  5.13.32"
    echo -e " [   ${WHITE_R}2${RESET}   ]  |  5.14.23"
    echo -e " [   ${WHITE_R}3${RESET}   ]  |  6.0.45"
    echo -e " [   ${WHITE_R}4${RESET}   ]  |  6.1.71"
    echo -e " [   ${WHITE_R}5${RESET}   ]  |  6.2.26"
    echo -e " [   ${WHITE_R}6${RESET}   ]  |  6.4.54"
    echo -e " [   ${WHITE_R}7${RESET}   ]  |  6.5.55"
    if [[ "${release_stage}" == 'RC' ]]; then
...
elif [[ "${first_digit_unifi}" == '5' && "${second_digit_unifi}" == '13' ]]; then
  release_wanted
  header
  echo "  To what UniFi Network Application version would you like to update?"
  echo -e "  Currently your UniFi Network Application is on version ${WHITE_R}$unifi${RESET}"
  echo -e "\\n  Release stage is set to | ${WHITE_R}${release_stage_friendly}${RESET}\\n\\n"
  if [[ "${unifi}" == "5.13.32" ]]; then
    unifi_version='5.13.32'
    echo -e " [   ${WHITE_R}1${RESET}   ]  |  5.14.23"
    echo -e " [   ${WHITE_R}2${RESET}   ]  |  6.0.45"
    echo -e " [   ${WHITE_R}3${RESET}   ]  |  6.1.71"
    echo -e " [   ${WHITE_R}4${RESET}   ]  |  6.2.26"
    echo -e " [   ${WHITE_R}5${RESET}   ]  |  6.4.54"
    echo -e " [   ${WHITE_R}6${RESET}   ]  |  6.5.55"
    if [[ "${release_stage}" == 'RC' ]]; then
...
elif [[ "${first_digit_unifi}" == '5' && "${second_digit_unifi}" == '14' ]]; then
  release_wanted
  header
  echo "  To what UniFi Network Application version would you like to update?"
  echo -e "  Currently your UniFi Network Application is on version ${WHITE_R}$unifi${RESET}"
  echo -e "\\n  Release stage is set to | ${WHITE_R}${release_stage_friendly}${RESET}\\n\\n"
  if [[ "${unifi}" == "5.14.23" ]]; then
    unifi_version='5.14.23'
    echo -e " [   ${WHITE_R}1${RESET}   ]  |  6.0.45"
    echo -e " [   ${WHITE_R}2${RESET}   ]  |  6.1.71"
    echo -e " [   ${WHITE_R}3${RESET}   ]  |  6.2.26"
    echo -e " [   ${WHITE_R}4${RESET}   ]  |  6.4.54"
    echo -e " [   ${WHITE_R}5${RESET}   ]  |  6.5.55"
    if [[ "${release_stage}" == 'RC' ]]; then
...
elif [[ "${first_digit_unifi}" == '6' && "${second_digit_unifi}" == '0' ]]; then
  release_wanted
  header
  echo "  To what UniFi Network Application version would you like to update?"
  echo -e "  Currently your UniFi Network Application is on version ${WHITE_R}$unifi${RESET}"
  echo -e "\\n  Release stage is set to | ${WHITE_R}${release_stage_friendly}${RESET}\\n\\n"
  if [[ "${unifi}" == "6.0.45" ]]; then
    unifi_version='6.0.45'
    echo -e " [   ${WHITE_R}1${RESET}   ]  |  6.1.71"
    echo -e " [   ${WHITE_R}2${RESET}   ]  |  6.2.26"
    echo -e " [   ${WHITE_R}3${RESET}   ]  |  6.4.54"
    echo -e " [   ${WHITE_R}4${RESET}   ]  |  6.5.55"
    if [[ "${release_stage}" == 'RC' ]]; then
...
elif [[ "${first_digit_unifi}" == '6' && "${second_digit_unifi}" == '1' ]]; then
  release_wanted
  header
  echo "  To what UniFi Network Application version would you like to update?"
  echo -e "  Currently your UniFi Network Application is on version ${WHITE_R}$unifi${RESET}"
  echo -e "\\n  Release stage is set to | ${WHITE_R}${release_stage_friendly}${RESET}\\n\\n"
  if [[ "${unifi}" == "6.1.71" ]]; then
    unifi_version='6.1.71'
    echo -e " [   ${WHITE_R}1${RESET}   ]  |  6.2.26"
    echo -e " [   ${WHITE_R}2${RESET}   ]  |  6.4.54"
...
elif [[ "${first_digit_unifi}" == '6' && "${second_digit_unifi}" == '2' ]]; then
  release_wanted
  header
  echo "  To what UniFi Network Application version would you like to update?"
  echo -e "  Currently your UniFi Network Application is on version ${WHITE_R}$unifi${RESET}"
  echo -e "\\n  Release stage is set to | ${WHITE_R}${release_stage_friendly}${RESET}\\n\\n"
  if [[ "${unifi}" == "6.2.26" ]]; then
    unifi_version='6.2.26'
    echo -e " [   ${WHITE_R}1${RESET}   ]  |  6.4.54"
...
elif [[ "${first_digit_unifi}" == '6' && "${second_digit_unifi}" == '3' ]]; then
  release_wanted
  header
  echo "  To what UniFi Network Application version would you like to update?"
  echo -e "  Currently your UniFi Network Application is on version ${WHITE_R}$unifi${RESET}"
...
elif [[ "${first_digit_unifi}" == '6' && "${second_digit_unifi}" == '4' ]]; then
  release_wanted
  header
  echo "  To what UniFi Network Application version would you like to update?"
  echo -e "  Currently your UniFi Network Application is on version ${WHITE_R}$unifi${RESET}"
  echo -e "\\n  Release stage is set to | ${WHITE_R}${release_stage_friendly}${RESET}\\n\\n"
  if [[ "${unifi}" == "6.4.54" ]]; then
...
##########################################################################################################################################################################
  ...
  if [[ "${third_digit_unifi}" -gt '55' ]]; then not_supported_version; fi
  release_wanted
  if [[ "${release_stage}" == 'RC' ]]; then if [[ "${unifi}" == "${rc_version_available}" ]]; then debug_check_no_upgrade; unifi_update_latest; fi; fi
  if [[ "${release_stage}" == 'S' ]]; then if [[ "${unifi}" == "6.5.55" ]]; then debug_check_no_upgrade; unifi_update_latest; fi; fi
  header
  echo "  To what UniFi Network Application version would you like to update?"
  echo -e "  Currently your UniFi Network Application is on version ${WHITE_R}$unifi${RESET}"
  echo -e "\\n  Release stage is set to | ${WHITE_R}${release_stage_friendly}${RESET}\\n\\n"
